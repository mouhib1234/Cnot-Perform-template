...
export default function ContactUs() {
  return (
    <div className="relative isolate mt-10 border-t border-neutral-800  ">
          ...
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <dl className="mt-10 space-y-4 text-base/7 text-gray-300">
              <div className="flex gap-x-4">
                ...
                <dd>
                  Centre Culturel et Sportif de la Jeunesse Tunis
                  <br />
                  El Menzah 6 -2091
                </dd>
              </div>
        ...
        >
          <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
            ...
            <div className="mt-8 flex justify-end">
              <button
                type="submit"
                className="bg-[#ba52ed] py-3 px-6 rounded-full text-center text-sm  text-white shadow-xs hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
              >
                Send message
              </button>
            </div>
