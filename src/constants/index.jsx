...
export const aboutItems = [
  ...
  },
  {
    id: 2,
    description:
      "Analysez vos données pour révéler vos forces et points d'amélioration.",
  },
  {
    id: 3,
    description:
      "Recevez des conseils personnalisés et prévenez les blessures.",
  },
  {
    id: 4,
...
export const navigation = {
  ...
  support: [
    ...
    {
      name: "Centre Culturel et Sportif de la Jeunesse El Menzah 6 -2091 Tunis",
      href: "#",
    },
    { name: "president.cnot@cnotunisie.tn", href: "#" },
    { name: "cnotperform.com", href: "#" },
  ],
  company: [
    { name: "About", href: "#" },
    { name: "Blog", href: "#" },
...
export const champions = [
  {
    ...
    image: "https://www.cnotperform.com/assets/img/athletes/mallouli.jpg",
  },
  {
    name: "Habiba Ghribi",
    sport: "Athletics",
    medals: { gold: 1, silver: 1, bronze: 0 },
    image: "https://www.cnotperform.com/assets/img/athletes/ghribi.jpg",
  },
  {
    name: "Mohamed Gammoudi",
    sport: "Athletics",
    medals: { gold: 1, silver: 1, bronze: 1 },
    image:
      "https://www.cnotperform.com/assets/img/athletes/Mohamed-Gammoudi.jpg",
  },
];
